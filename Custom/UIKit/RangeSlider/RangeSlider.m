...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _maxThumbOn = false;
        _padding = 20;
        UIImage *_img = [UIImage imageNamed:@"bar-background.png"];
        _trackBackground = [[UIImageView alloc] initWithImage:[_img stretchableImageWithLeftCapWidth:_img.size.width/2 topCapHeight:0]];
        _trackBackground.width = CGRectGetWidth(frame)-_padding;
        _trackBackground.center = CGPointMake(self.center.x-_padding/2, self.center.y);
        [self addSubview:_trackBackground];
        
        _img = [UIImage imageNamed:@"bar-highlight.png"];
        _track = [[UIImageView alloc] initWithImage:[_img stretchableImageWithLeftCapWidth:_img.size.width topCapHeight:0]];
        _track.width = CGRectGetWidth(frame)-_padding;
